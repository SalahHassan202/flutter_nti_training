...
import 'package:project_app/features/fav/cubit/cubit/fav_cubit.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color.fromARGB(255, 41, 205, 238),
        elevation: 0,
        centerTitle: true,
        title: const Text(
          "Laptops Store",
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text(
                      "${widget.laptop.price} EGP",
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.bold,
                        color: Color.fromARGB(255, 3, 221, 237),
                      ),
                    ),
                    const Spacer(),
                    ElevatedButton(
